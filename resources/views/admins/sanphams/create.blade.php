                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="text" class="form-control @error('ten_san_pham') is-invalid @enderror" name="ten_san_pham" id="ten_san_pham" placeholder="Nhập tên sản phẩm" 
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control @error('gia') is-invalid @enderror" id="gia" name="gia" placeholder="Giá bán"
                                                 value="{{ old('gia') }}" >
                                                @error('gia')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control @error('gia_khuyen_mai') is-invalid @enderror"
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <textarea class="form-control   @error('mo_ta') is-invalid @enderror" name="mo_ta" id="mo_ta" rows="4" 
